...
//        if (key.equals(getString(R.string.pref_choose_program_key))){
//            int programID = Integer.parseInt(sharedPreferences.
//                    getString(getString(R.string.pref_choose_program_key),
//                            getString(R.string.pref_program_pgd_value)));
//
//            //CourseAdapter.alert();
//            int number;
//            number = programID;
